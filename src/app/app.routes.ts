  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: 'fabricantes',
        loadChildren: () =>
          import('./modules/fabricantes/fabricantes.routes').then(m => m.FABRICANTES_ROUTES),
      },
      {
        path: 'planes',
        loadChildren: () => import('./modules/planes/planes.routes').then(m => m.PLANES_ROUTES),
      },
      {
        path: 'productos',
        loadChildren: () =>
          import('./modules/productos/productos.routes').then(m => m.PRODUCTOS_ROUTES),
      },
      {
        path: 'rutas',
      ...
      },
      {
        path: 'vendedores',
        loadChildren: () =>
          import('./modules/vendedores/vendedores.routes').then(m => m.VENDEDORES_ROUTES),
      },
      {
        path: 'ventas',
